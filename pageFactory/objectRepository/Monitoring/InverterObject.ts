export class InverterObject {
    ...
    protected objpower = `//div[@class="card-name"]/h4[contains(text(),"Specific Power")]/parent::div/h3`;
    protected objdailyenergy = `//div[@class="inverterCharts"]//div/h2[@class="txt-reg"]`
