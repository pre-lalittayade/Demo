export class BildJMRObject {
    ...
    protected selectjmrforbulkupdate = (value: string) => `//div[@class="ag-center-cols-clipper"]//*//div[contains(text(),"${value}")]`;
    //div[@class="ag-center-cols-clipper"]//*//div[contains(text(),"${value}")]//parent::div//*//input[@type="checkbox"]
