export class CommonMethodsObject {
    ...
    //Sorting
    protected columnHeading = (columnName: string) => `//div[@class="ag-header-row ag-header-row-column"]//div[@col-id="${columnName}"]`;
    protected columnValues = (columnName: string) => `//div[contains(@aria-label,"Press SPACE ")]//div[@col-id="${columnName}"]`;
    //
    protected filterclose = `#CloseId`;
    protected filter = `//button[@mattooltip="Filter"]`;
    protected reset = `//button[@id="ResetId"]`;
    ...
    protected cancel_btn = `//mat-icon[contains(text(),'cancel')]`;
