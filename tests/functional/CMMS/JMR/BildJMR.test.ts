...
test(" Scenario 1 automation", async ({ loginPage, homePage, BildJMR }) => {
    ...
    await test.step('Enter Costum Alerts page', async () => {
        ...
        await BildJMR.JMRStartDateButton();
        await BildJMR.SelectDate(JMRData.JMRStartDate);
        await BildJMR.JMREndDateButton();
        await BildJMR.SelectDate(JMRData.JMREndDate);
        ...
        // Approver
        await BildJMR.FilterDropdownApprover(JMRData.ApproverSearchButton, JMRData.AddApproverUser2);
        // Billing Month
        ...
        await BildJMR.SearchButton(JMRData.ApproverSearchButton);
        await BildJMR.AddUser(JMRData.EditApproverUser1);
        await BildJMR.MenuButtons(JMRData.SaveButton);
        await BildJMR.SavePopUp(JMRData.PopUpYes);
        await BildJMR.SavePopUp(JMRData.PopUpOk);
        // Again For filtering 
